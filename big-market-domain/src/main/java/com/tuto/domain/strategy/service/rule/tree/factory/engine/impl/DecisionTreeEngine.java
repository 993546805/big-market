package com.tuto.domain.strategy.service.rule.tree.factory.engine.impl;

import com.tuto.domain.strategy.model.valobj.RuleLogicCheckTypeVO;
import com.tuto.domain.strategy.model.valobj.RuleTreeNodeLineVO;
import com.tuto.domain.strategy.model.valobj.RuleTreeNodeVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardData process(String userId, Long strategyId, Integer awardId) {
        ...
        while (null != nextNode) {
            ...
            log.info("决策树引擎[{}]treeId:{} node:{} code:{}", ruleTreeVO.getTreeName(), ruleTreeVO.getTreeId(), ruleTreeNode.getRuleKey(), ruleLogicCheckType);
