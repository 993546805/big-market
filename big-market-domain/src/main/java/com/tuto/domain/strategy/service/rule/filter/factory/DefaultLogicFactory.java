package com.tuto.domain.strategy.service.rule.filter.factory;
...
public class DefaultLogicFactory {
    ...
    public enum LogicModel {
        RULE_WEIGHT("rule_weight", "[抽奖前规则]根据抽奖权重返回可抽奖范围", "before"),
        RULE_BLACKLIST("rule_blacklist", "[抽奖前规则]黑名单规则过滤,命中黑名单则直接返回","before"),
        RULE_WHITE_LIST("rule_whitelist", "[抽奖前规则]白名单规则过滤,命中白名单则直接返回", "before"),
        RULE_LOCK("rule_lock", "[抽奖中规则]抽奖n次后，对应奖品可解锁抽奖", "center"),
        RULE_LUCK_AWARD("rule_luck_award", "[抽奖中规则]抽奖n次后，对应奖品可解锁抽奖", "after"),
